# Import libraries
import torch, torchmetrics, wandb, timm, argparse, yaml, os, pickle, time
...
def run(args):
    ...
    tr_dl, val_dl, test_dl = torch.load("saved_dls/tr_dl_experiments.pth"), torch.load("saved_dls/val_dl_experiments.pth"), torch.load("saved_dls/test_dl_experiments.pth")
    ...
    wandb_logger = WandbLogger(project = "recycle_park_experiments", job_type = "train", name = f"{args.model_name}_{args.dataset_name}_{args.batch_size}_{args.learning_rate}")
    ...
    print(f"{args.epochs} epoch-training using {args.model_name} is completed in {end_time} secs")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-mn", "--model_name", type = str, default = "rexnet_200", help = "Model name for backbone")
    ...
    parser.add_argument("-lr", "--learning_rate", type = float, default = 0.0022908676527677745, help = "Learning rate value")
    # parser.add_argument("-lr", "--learning_rate", type = float, default = 0.00017378008287493763, help = "Learning rate value")
    # parser.add_argument("-lr", "--learning_rate", type = float, default = 0.012022644346174132, help = "Learning rate value")
    # parser.add_argument("-lr", "--learning_rate", type = float, default = 0.002754228703338169, help = "Learning rate value")
    # parser.add_argument("-lr", "--learning_rate", type = float, default = 0.0004365158322401656, help = "Learning rate value")
